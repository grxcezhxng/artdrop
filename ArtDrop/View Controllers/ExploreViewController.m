...
- (void)_renderStyling {
    ...
    UIImage *const resizedMapImage = [imageHelper resizeImage:[UIImage imageNamed:@"map.jpg"] withSize:CGSizeMake(375, 250)];
    [self.mapModule setBackgroundColor:[UIColor colorWithPatternImage:resizedMapImage]];
    UIImage *const resizedSearchImage = [imageHelper resizeImage:[UIImage imageNamed:@"search.jpg"] withSize:CGSizeMake(375, 250)];
